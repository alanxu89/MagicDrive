...
@dataclass
class FPVStableDiffusionPipelineOutput(BaseOutput):
    """
...
class StableDiffusionFPVMultiControlNetPipeline(
    ...
    def prepare_extra_step_kwargs(self, generator, eta):
        ...
        if accepts_generator:
            raise RuntimeError(
                "If you fixed the logic for generator, please remove this. Otherwise, please use other sampler."
            )
    ...
    def decode_latents(self, latents):
        ...
        image = rearrange(image.cpu(),
                          '... c h w -> ... h w c').float().numpy()
        return image
    ...
    def __call__(
        ...
        return FPVStableDiffusionPipelineOutput(
